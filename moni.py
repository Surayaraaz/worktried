...
connectiondb = mysql.connector.connect(host="localhost", user="root", password="", database="developtreeshrms", port=3306)
cursordb = connectiondb.cursor()

b = list()
print(connectiondb)
json_object = json.loads(sys.argv[1])
employee_id = json_object.get("employee_id") 
class AcitivyList:
    ...
    try:
        while True:
            ...
            if active_window_name != new_window_name:
                ...
                sql = "INSERT INTO monitoring (employee_id, m_title, m_log_ts) VALUES (%s, %s, %s)"
                val = (employee_id, al, ct)
