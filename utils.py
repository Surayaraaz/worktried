...
def caltable(self,year,month,request):
    ...
    special_weekends_a = customholidays.objects.all()
    ...
    days_list = f'<table border="0" cellpadding="0" cellspacing="0" class="calendar">{head()}<th>Date</th><th>Status</th><th></th><th>Check in</th><th>Check out</th><th>Duration</th></tr>'
    ...
    for day in days:
        ...
        if allsat != 1 and day.strftime('%A') == "Saturday":
           ...
           if sat1_value == 1 and saturdays_encountered == 1 :
               days_list+=f'<tr><td>{day_str}</td><td colspan="6" style="background-color: black;font-size:20px;">weekend1</td></tr>'
           ...
           if sat2_value == 1  and saturdays_encountered == 2 :
               days_list+=f'<tr><td>{day_str}</td><td colspan="6" style="background-color: black;font-size:20px;">weekend2</td></tr>'
           ...
           if sat3_value == 1  and saturdays_encountered == 3 :
               days_list+=f'<tr><td>{day_str}</td><td colspan="6" style="background-color: black;font-size:20px;">weekend3</td></tr>'
           ...
           if sat4_value == 1  and saturdays_encountered == 4 :
               days_list+=f'<tr><td>{day_str}</td><td colspan="6" style="background-color: black;font-size:20px;">weekend4</td></tr>'
           ...
           if sat5_value == 1  and saturdays_encountered == 5 :
               days_list+=f'<tr><td>{day_str}</td><td colspan="6" style="background-color: black;font-size:20px;">weekend5</td></tr>'
...
class Calendar1(HTMLCalendar):
    ...
    def formatmonth(self,request, withyear=True): 
        ...
        return cal
def head():
    return f'<h1 style="color:white; font-size:24px;padding-top:20px;">Attendance</h1><p style="color:white; font-size:14px;">To apply for leaves, or to update your attendance data, please click on the edit button next to a date. To apply for many leaves together, please <a href="employ_apply_leave">click here</a>.</p>'
